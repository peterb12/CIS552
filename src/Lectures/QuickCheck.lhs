...
`N` and satisfied the predicate denoted by the string `COND`.
...
This function is higher-order; it takes a generator with a size parameter and
uses it to develop a new generator by progressively increasing this size.
