...
The first hit on [Hoogle](https://www.haskell.org/hoogle/) for this type is
the standard library function `lookup`:
...
See if you can improve your definition of `encodeContent` using this
operator.
