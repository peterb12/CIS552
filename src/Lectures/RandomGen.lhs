---
fulltitle: "Exercise: Using the State monad for Random Generation"
...
Although we don't have QCs combinators available, you should be able to
control the frequency of when cons and nil is generated so that you get
reasonable lists.
