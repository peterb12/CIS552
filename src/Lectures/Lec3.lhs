...
from Ints to Ints! Equipped with this knowledge, consider the function
...
seen some defined in the standard prelude. For example
...
an exception (like `undefined` does) or go into an infinite loop.  (NB: Using
