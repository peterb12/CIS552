...
declarations. See if you can finish this instance for trees.
...
What about a function that uses lookup, what is its type? See if you
can guess the type that GHC infers for this function:
